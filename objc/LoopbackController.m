...
- (void)applicationDidFinishLaunching:(NSNotification *)notification {
  ...
  ret = [panel runModalForDirectory:@"/Users/Aleks/Documents/School" file:nil types:nil];
#else
  [panel setDirectoryURL:[NSURL fileURLWithPath:@"/Users/Aleks/Documents/School"]];
  ret = [panel runModal];
#endif
  ...
  NSString* mountPath = @"/Volumes/dropboxpp_objc";
  ...
  [NSString stringWithFormat:@"volicon=%@",
   [[NSBundle mainBundle] pathForResource:@"DropboxppObjcFS" ofType:@"icns"]];
  ...
  [options addObject:@"volname=DropboxppObjcFS"];
